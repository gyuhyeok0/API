...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        /*
            필기. compareTo() : 인자로 문자열을 전달하여, 같으면 0을 반환, 전달 된 문자열이 작으면 음수
                크면 양수를 반환한다.
         */
        ...
        /* 필기. compareToIgnoraCase() : 대소문자 구분하지 않고 비교  */

        System.out.println("compareToIgnoraCase() : " + (str3.compareToIgnoreCase(str4)));
        ...
        String casStr = "JAvaOracle";
        System.out.println("toLowerCase() : " + casStr.toLowerCase());

        // 필기. length(); 문자열의 길이를 정수형으로 반환

        // 필기. replace() : 무자열에서 대체할 문자열을 변경해서 반환, 원본 영향 x
        String javaoracle = "javaoracle";
        System.out.println(javaoracle.replace("java", "python"));

        //필기. isEmpty() : 문자열의 길이가 0 이면 true, 아니면 false 반환
        System.out.println();
    }
